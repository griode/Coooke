...
export const OutlineButton = ({
    ...
    return (
        <button
            ...
            className={`rounded-full border-2 border-slate-400 md:text-sm px-4 py-2 
        ${disabled
...
export const IconButton = ({
    ...
    return (
        <button
            onClick={!disabled ? onClick : undefined}
            className={`rounded-full border-2 text-xl font-bold p-2 flex items-center justify-center
        ${disabled
