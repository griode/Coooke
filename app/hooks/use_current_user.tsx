...
import UserModel from "@/app/lib/model/user_model";
import UserProvider from "@/app/lib/provider/user_provider"; // Assurez-vous que `auth` est correctement configuré dans Firebase.
