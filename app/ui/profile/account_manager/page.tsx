...
const formatDate = (date: Date) => {
    ...
    const month = String(d.getMonth() + 1).padStart(2, "0"); // the months start at 0
                    ...
                    <div className="border p-4 rounded-3xl mt-6">
                        ...
                        <input
                            ...
                            onChange={(e) => {
                                if (
                                    e.target.value ==
                                    formatDate(userInfo?.birth.toDate() ?? new Date())
                                ) {
                                    setIsUpdate(true);
                                } else {
                                    setIsUpdate(false);
                            ...
                            defaultValue={formatDate(userInfo?.birth.toDate() ?? new Date())}
                ...
                <label htmlFor="language">
                    <div className="border p-4 rounded-3xl mt-6">
                        ...
                        <select
                            ...
                            id="language"
                            onChange={(e) => {
                                if (userInfo?.language == e.target.value) {
                                    setIsUpdate(true);
                                } else {
                                    setIsUpdate(false);
                                }
                            }}
                            defaultValue={userInfo?.language ?? "en"}
