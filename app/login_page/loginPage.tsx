...
import { signInWithGoogle } from "@/app/api/authentication/sign_with_google";
...
import { setUserId } from "@/app/utils/user_manager";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={`bg-[url('../assets/images/login_bg.png')] w-full h-60 md:h-96  bg-cover`}
        ></div>
        <div className="m-4">
